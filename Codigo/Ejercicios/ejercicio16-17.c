 ...
 * Ejercicios 16 y 17
 *
 * [Ejercicio 16] Implemente las siguientes 3 estructuras:
 *
 ...
 *
 *  [Ejercicio 17] Utilizando las estructuras del ejercicio 16, implemente las
 *  funciones para agregar video juegos a la tienda, registrar una nueva compra,
 *  imprimir registros de video juegos, imprimir registros de compras y eliminar
 *  un video juego. 
 * 
 *   Tips: Utilice memoria dinámica.
 *
 * 
 *  Criterio evaluación ejercicio 16:
 *     - Test 1: Define correctamente la estructura video juego
 * 
 *     - Test 2: Define correctamente la estructura compra
 *
 *     - Test 3: Define correctamente la estructura tienda
 *
 *  
 *  Criterio evaluación ejercicio 17:
 *     - Test 1: Implementa correctamente la función agregar video juego
 * 
 *     - Test 2: Implementa correctamente la función registrar compra
 *
 *     - Test 3: Implementa correctamente las funciones para imprimir los video
 *       juegos y los registros de compra
 *
 *     - Test 4: Implementa correctamente la función para eliminar un video juego
 *
 *
 * Puntaje ejercicio 16
 ...
 *
 *
 * Puntaje ejercicio 17
 *  - Código ordenado (indentado y con comentarios explicativos): +0.2 pts
 *  - 4 tests correctos: +0.8 pts
 *  - 3 tests correctos: +0.6 pts
 *  - 2 tests correctos: +0.4 pts
 *  - 1 test correcto: +0.2 pts
 *  - 0 test correctos: +0 pts
 */
